...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Outfit', sans-serif; }
        ...
        .subtitle { color: #9ca3af; font-size: 14px; margin-bottom: 35px; line-height: 1.5; }
        ...
        @media (max-width: 480px) {
            ...
            .recover-card { padding: 34px 22px; }
    ...
    <div class="auth-layout">
        <aside class="games-panel" aria-hidden="true">
            ...
            <div class="games-content">
                <h2>Recupera a tua conta.</h2>
                <p>Volta rapidamente para continuares a gerir a tua coleção de jogos.</p>
            </div>
        </aside>
