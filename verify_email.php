...
if (isset($_GET['token'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($updateStmt->execute()) {
            $message = "Email verificado com sucesso! A tua conta está ativa.";
        ...
        $message = "Este token é inválido ou a conta já foi verificada anteriormente.";
        $messageClass = "error";
    }
} else {
    ...
    <div class="auth-layout">
        <aside class="games-panel" aria-hidden="true">
            ...
            <div class="games-content">
                ...
                <p>A tua conta fica pronta para explorares jogos, reviews e listas.</p>
            </div>
        </aside>
        ...
        <main class="auth-panel">
            <div class="verify-card">
                ...
                <?php if ($messageClass === "success"): ?>
                    <a href="login.php" class="btn">Entrar na Conta</a>
                <?php else: ?>
